...
const FAQs = () => {
	...
	return (
		<div className='centered-content'>
			<h3>FAQs</h3>
			<strong>What is your camper/staff ratio?</strong>
			<p>
			...
			<strong>How do I communicate with my son during the summer?</strong>
			<p>
			...
			<strong>Can I send my son care packages?</strong>
