...
const Trips = () => {
	...
	return (
		<div>
			...
			<br></br>
		          <br></br>
		        <h1 style={{ align: "center" }}>Trips</h1>
		        <h2>
		          Each boy chooses his own trips with guidance from the staff. Time on the trail and water teaches self-reliance and community cooperation.</h2>
		          <br></br>
		          <br></br>
		          <p>
		          Each trip is led by at least one Wilderness First Responder — an 80 hour intensive medical course on how to provide first-aid in the backcountry.
		          A trip’s success is both an individual and a group accomplishment — each camper faces their own challenges to overcome, but has a group of peers to help them find success.
		          Map and compass skills, building shelters, understanding ecosystems, LNT
		          Over 40 canoe, kayak, and hiking trips depart from Pine Island each summer, taking campers and counselors from the summits of Mt. Washington and Katahdin to the border waters between Maine and Canada.
		           For the youngest campers, two- or three-day trips teach fundamental camping skills. Fourteen- and fifteen-year-old campers may go for as long as a week into wild country. 
		        </p>
			</div>
			...
			<div className='activity-list slide'>
		        ...
		        <ul>
		        	<p>Bald Pate - three-day hike on the Appalachian Trail for beginning hikers.
		        	</p>
		        	<p>
					...
					<p>
						Cpffhanger - four-day trip in the White Mountains from Ethan Pond to the Kangamangus Highway including Mt. Guyot and Mt. Bond. For intermediate hikers.
					</p>
					<p>
